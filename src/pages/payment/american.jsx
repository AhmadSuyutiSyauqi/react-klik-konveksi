        ...
        <div className="w-full">
          <div className="kain mt-6 flex p-2 bg-gray-300 ml-2">
            <div className="w-20 rounded-md lg:w-32">
              <img src={americanDrill} alt="American Drill" />
            </div>
            ...
            <div className="ml-2">
              ...
              <p className="text-gray-600 text-[0.6rem] font-medium lg:text-xs">
                <span className="text-black">Gramasi :</span> 210 - 215 gsm
              </p>
              <p className="text-gray-600 text-[0.6rem] font-medium lg:text-xs">
                <span className="text-black">Rekomendasi (*) :</span> Kemeja PDH, Kemeja PDL
              </p>
            </div>
          </div>
...
export default PaymentAmericanPage;
